...
class CalculatorPage:
	...
	def read_used_rounds(self) -> Tuple[float, int]:
	...
	def calculate_handicap_index(self) -> float:
		...
		print("current: ", current_handicap_index)
		# calculate low handicap index
		low_handicap_index = self.calculate_low_handicap_index(current_handicap_index, used_differentials)
		print("low: ", low_handicap_index)
		# fetch actual handicap
		current_handicap_index, soft_cap, hard_cap = self.limit_on_upward_movement(current_handicap_index, low_handicap_index)
